...
import com.skyfalling.mosika.ui.web.service.RuleDefinitionService;
...
public class RuleDefinitionController {
    ...
    public ApiResponse<RuleDefinitionEntity> get(@PathVariable long id) {
        ...
        if (e == null) {
            throw new com.skyfalling.mosika.ui.web.common.BusinessException(404, "rule not found: " + id);
        }
