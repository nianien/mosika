/**
 * Mosika UI 树的语义模型核心（终态：前后端统一以后端 TreeNode JSON 为唯一语义结构）。
 *
...
(function (root, factory) {
    ...
    /** 语义树 → 后端 TreeNode JSON 对象（保留自定义 label，省略默认 label 与所有瞬时字段）。 */
    ...
    /** 后端 TreeNode JSON（字符串或对象）→ 语义树；恢复自定义 label，忽略未知/瞬时字段。 */
