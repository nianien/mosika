...
VALUES
    (20001, (SELECT id FROM rule_namespace WHERE code='default'), '内容生成任务智能路由', '根据内容类型与时效要求，把创作任务路由到快讯、营销文案或深度文章生成流程',
     '{"type":"T","expr":"","next":{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"R","expr":"r10011","name":"命中快讯时效窗口","negative":false},"action":{"type":"A","expr":"f20003"}},{"type":"J","expr":"J","rule":{"type":"R","expr":"r10013","name":"命中营销文案模式","negative":false},"action":{"type":"A","expr":"f20004"}},{"type":"J","expr":"J","rule":{"type":"R","expr":"r10012","name":"命中深度文章模式","negative":false},"action":{"type":"A","expr":"f20002"}}],"action":{"type":"A","expr":"r10116"}}}',
     1, 0)
...
VALUES
    (20002, (SELECT id FROM rule_namespace WHERE code='default'), '标准深度文章生成', '以深层递归树表达准入、证据决策、生成子树、SEO 和发布风险决策的完整内容生产链路',
     '{"type":"T","expr":"","next":{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"深度文章生产准入","negative":false,"rules":[{"type":"L","expr":"&&","name":"业务准入","negative":false,"rules":[{"type":"L","expr":"&&","name":"内容模式与请求","negative":false,"rules":[{"type":"R","expr":"r10012","name":"命中深度文章模式","negative":false},{"type":"R","expr":"r10001","name":"创作请求完整","negative":false}]},{"type":"L","expr":"&&","name":"主题与渠道","negative":false,"rules":[{"type":"R","expr":"r10004","name":"主题相关性达标","negative":false},{"type":"R","expr":"r10015","name":"发布渠道受支持","negative":false}]}]},{"type":"L","expr":"&&","name":"运行资源准入","negative":false,"rules":[{"type":"R","expr":"r10016","name":"生成配置就绪","negative":false},{"type":"R","expr":"r10017","name":"生成预算充足","negative":false}]}]},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"f20006"},{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"证据链完整","negative":false,"rules":[{"type":"R","expr":"r10018","name":"素材时效达标","negative":false},{"type":"R","expr":"r10019","name":"证据覆盖达标","negative":false}]},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10120"},{"type":"A","expr":"r10121"},{"type":"P","expr":"P","branches":[{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10102"},{"type":"A","expr":"r10103"},{"type":"A","expr":"r10122"},{"type":"A","expr":"r10123"}]},{"type":"A","expr":"r10135"}]},{"type":"J","expr":"J","rule":{"type":"R","expr":"r10023","name":"需要搜索优化","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10124"},{"type":"A","expr":"r10128"}]}},{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"R","expr":"r10021","name":"命中监管敏感主题","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10130"},{"type":"A","expr":"r10128"}]}},{"type":"J","expr":"J","rule":{"type":"R","expr":"r10022","name":"命中高影响发布","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10131"},{"type":"A","expr":"r10128"}]}}],"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"f20007"},{"type":"A","expr":"f20005"}]}}]}},{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"具备素材补全基础","negative":false,"rules":[{"type":"R","expr":"r10002","name":"素材数量达标","negative":false},{"type":"R","expr":"r10003","name":"可信素材占比达标","negative":false}]},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10129"},{"type":"A","expr":"r10128"}]}}],"action":{"type":"A","expr":"r10109"}}]}}],"action":{"type":"A","expr":"r10109"}}}',
     1, 0)
ON CONFLICT(id) DO UPDATE SET
    name=excluded.name, description=excluded.description, rule_tree=excluded.rule_tree,
    status=excluded.status, version=rule_flow.version + 1, updated_at=datetime('now','localtime')
...
VALUES
    (20003, (SELECT id FROM rule_namespace WHERE code='default'), '突发快讯生成', '以深层递归树表达时效准入、证据决策、双路并行生成和分级发布风险处理',
     '{"type":"T","expr":"","next":{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"突发快讯生产准入","negative":false,"rules":[{"type":"L","expr":"&&","name":"业务准入","negative":false,"rules":[{"type":"L","expr":"&&","name":"时效与请求","negative":false,"rules":[{"type":"R","expr":"r10011","name":"命中快讯时效窗口","negative":false},{"type":"R","expr":"r10001","name":"创作请求完整","negative":false}]},{"type":"L","expr":"&&","name":"信源与渠道","negative":false,"rules":[{"type":"R","expr":"r10014","name":"快讯双源确认","negative":false},{"type":"R","expr":"r10015","name":"发布渠道受支持","negative":false}]}]},{"type":"L","expr":"&&","name":"运行资源准入","negative":false,"rules":[{"type":"R","expr":"r10016","name":"生成配置就绪","negative":false},{"type":"R","expr":"r10017","name":"生成预算充足","negative":false}]}]},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"f20006"},{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"快讯证据链完整","negative":false,"rules":[{"type":"R","expr":"r10018","name":"素材时效达标","negative":false},{"type":"R","expr":"r10019","name":"证据覆盖达标","negative":false}]},"action":{"type":"S","expr":"S","branches":[{"type":"P","expr":"P","branches":[{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10120"},{"type":"A","expr":"r10121"},{"type":"A","expr":"r10110"}]},{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10135"},{"type":"A","expr":"r10128"}]}]},{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"R","expr":"r10021","name":"命中监管敏感主题","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10130"},{"type":"A","expr":"r10128"}]}},{"type":"J","expr":"J","rule":{"type":"R","expr":"r10022","name":"命中高影响发布","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10131"},{"type":"A","expr":"r10128"}]}}],"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"f20007"},{"type":"A","expr":"f20005"}]}}]}},{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"具备素材补全基础","negative":false,"rules":[{"type":"R","expr":"r10002","name":"素材数量达标","negative":false},{"type":"R","expr":"r10003","name":"可信素材占比达标","negative":false}]},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10129"},{"type":"A","expr":"r10128"}]}}],"action":{"type":"A","expr":"r10109"}}]}}],"action":{"type":"A","expr":"r10109"}}}',
     1, 0)
ON CONFLICT(id) DO UPDATE SET
    name=excluded.name, description=excluded.description, rule_tree=excluded.rule_tree,
    status=excluded.status, version=rule_flow.version + 1, updated_at=datetime('now','localtime')
...
VALUES
    (20004, (SELECT id FROM rule_namespace WHERE code='default'), '营销文案生成', '以深层递归树表达活动与品牌准入、证据分流、双路准备、候选优选和高影响审核',
     '{"type":"T","expr":"","next":{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"营销文案生产准入","negative":false,"rules":[{"type":"L","expr":"&&","name":"业务准入","negative":false,"rules":[{"type":"L","expr":"&&","name":"内容与活动","negative":false,"rules":[{"type":"R","expr":"r10013","name":"命中营销文案模式","negative":false},{"type":"R","expr":"r10024","name":"营销活动有效","negative":false}]},{"type":"L","expr":"&&","name":"品牌与版权","negative":false,"rules":[{"type":"R","expr":"r10009","name":"品牌语调已配置","negative":false},{"type":"R","expr":"r10005","name":"版权风险可接受","negative":false}]}]},{"type":"L","expr":"&&","name":"运行准入","negative":false,"rules":[{"type":"L","expr":"&&","name":"请求与渠道","negative":false,"rules":[{"type":"R","expr":"r10001","name":"创作请求完整","negative":false},{"type":"R","expr":"r10015","name":"发布渠道受支持","negative":false}]},{"type":"L","expr":"&&","name":"配置与预算","negative":false,"rules":[{"type":"R","expr":"r10016","name":"生成配置就绪","negative":false},{"type":"R","expr":"r10017","name":"生成预算充足","negative":false}]}]}]},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"f20006"},{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"营销证据链完整","negative":false,"rules":[{"type":"R","expr":"r10018","name":"素材时效达标","negative":false},{"type":"R","expr":"r10019","name":"证据覆盖达标","negative":false}]},"action":{"type":"S","expr":"S","branches":[{"type":"P","expr":"P","branches":[{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10136"},{"type":"A","expr":"r10111"}]},{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10120"},{"type":"A","expr":"r10121"}]}]},{"type":"A","expr":"r10102"},{"type":"A","expr":"r10122"},{"type":"A","expr":"r10123"},{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"R","expr":"r10022","name":"命中高影响发布","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10131"},{"type":"A","expr":"r10128"}]}}],"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"f20007"},{"type":"A","expr":"f20005"}]}}]}},{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"具备素材补全基础","negative":false,"rules":[{"type":"R","expr":"r10002","name":"素材数量达标","negative":false},{"type":"R","expr":"r10003","name":"可信素材占比达标","negative":false}]},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10129"},{"type":"A","expr":"r10128"}]}}],"action":{"type":"A","expr":"r10109"}}]}}],"action":{"type":"A","expr":"r10109"}}}',
     1, 0)
ON CONFLICT(id) DO UPDATE SET
    name=excluded.name, description=excluded.description, rule_tree=excluded.rule_tree,
    status=excluded.status, version=rule_flow.version + 1, updated_at=datetime('now','localtime')
...
VALUES
    (20005, (SELECT id FROM rule_namespace WHERE code='default'), '发布前质量门禁', '以深层递归树表达并行检测、分级审核、嵌套自动发布资格和发布后审计',
     '{"type":"T","expr":"","next":{"type":"S","expr":"S","branches":[{"type":"P","expr":"P","branches":[{"type":"A","expr":"r10104"},{"type":"A","expr":"r10105"},{"type":"A","expr":"r10106"}]},{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"R","expr":"r10021","name":"命中监管敏感主题","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10130"},{"type":"A","expr":"r10128"}]}},{"type":"J","expr":"J","rule":{"type":"R","expr":"r10022","name":"命中高影响发布","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10131"},{"type":"A","expr":"r10128"}]}},{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"自动发布门禁","negative":false,"rules":[{"type":"L","expr":"&&","name":"内容可信","negative":false,"rules":[{"type":"L","expr":"&&","name":"事实与证据","negative":false,"rules":[{"type":"R","expr":"r10007","name":"事实置信度达标","negative":false},{"type":"R","expr":"r10019","name":"证据覆盖达标","negative":false}]},{"type":"L","expr":"&&","name":"版权与敏感","negative":false,"rules":[{"type":"R","expr":"r10005","name":"版权风险可接受","negative":false},{"type":"R","expr":"r10006","name":"敏感风险可接受","negative":false}]}]},{"type":"L","expr":"&&","name":"发布资格","negative":false,"rules":[{"type":"L","expr":"&&","name":"质量与原创","negative":false,"rules":[{"type":"R","expr":"r10008","name":"内容质量达标","negative":false},{"type":"R","expr":"r10020","name":"原创性达标","negative":false}]},{"type":"L","expr":"&&","name":"自动发布策略","negative":false,"rules":[{"type":"R","expr":"r10025","name":"允许自动发布","negative":false},{"type":"R","expr":"r10010","name":"无需人工复核","negative":true}]}]}]},"action":{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"R","expr":"r10015","name":"发布渠道受支持","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10108"},{"type":"A","expr":"r10128"}]}}],"action":{"type":"A","expr":"r10134"}}},{"type":"J","expr":"J","rule":{"type":"L","expr":"||","name":"普通人工复核门禁","negative":false,"rules":[{"type":"R","expr":"r10010","name":"需要人工复核","negative":false},{"type":"L","expr":"||","name":"可信度不足","negative":false,"rules":[{"type":"R","expr":"r10019","name":"证据覆盖不足","negative":true},{"type":"R","expr":"r10020","name":"原创性不足","negative":true}]}]},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10107"},{"type":"A","expr":"r10128"}]}}],"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10109"},{"type":"A","expr":"r10128"}]}}]}}',
     1, 0)
ON CONFLICT(id) DO UPDATE SET
    name=excluded.name, description=excluded.description, rule_tree=excluded.rule_tree,
    status=excluded.status, version=rule_flow.version + 1, updated_at=datetime('now','localtime')
...
VALUES
    (20006, (SELECT id FROM rule_namespace WHERE code='default'), '素材证据链构建', '完成素材清洗与检索、核心主张提取、引用绑定，并将证据充分、待补全和不可生成任务分流',
     '{"type":"T","expr":"","next":{"type":"S","expr":"S","branches":[{"type":"P","expr":"P","branches":[{"type":"A","expr":"r10101"},{"type":"A","expr":"r10117"}]},{"type":"A","expr":"r10118"},{"type":"A","expr":"r10119"},{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"证据链完整","negative":false,"rules":[{"type":"R","expr":"r10018","name":"素材时效达标","negative":false},{"type":"R","expr":"r10019","name":"证据覆盖达标","negative":false}]},"action":{"type":"A","expr":"r10128"}},{"type":"J","expr":"J","rule":{"type":"L","expr":"&&","name":"具备素材补全基础","negative":false,"rules":[{"type":"R","expr":"r10002","name":"素材数量达标","negative":false},{"type":"R","expr":"r10003","name":"可信素材占比达标","negative":false}]},"action":{"type":"A","expr":"r10129"}}],"action":{"type":"A","expr":"r10109"}}]}}',
     1, 0)
ON CONFLICT(id) DO UPDATE SET
    name=excluded.name, description=excluded.description, rule_tree=excluded.rule_tree,
    status=excluded.status, version=rule_flow.version + 1, updated_at=datetime('now','localtime')
...
VALUES
    (20007, (SELECT id FROM rule_namespace WHERE code='default'), '多渠道内容适配', '按微信、客户端和 Web 三类渠道执行不同内容投影，并记录可追溯的生成审计',
     '{"type":"T","expr":"","next":{"type":"D","expr":"D","branches":[{"type":"J","expr":"J","rule":{"type":"R","expr":"r10026","name":"目标渠道为微信","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10125"},{"type":"A","expr":"r10128"}]}},{"type":"J","expr":"J","rule":{"type":"R","expr":"r10027","name":"目标渠道为客户端","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10126"},{"type":"A","expr":"r10128"}]}},{"type":"J","expr":"J","rule":{"type":"R","expr":"r10028","name":"目标渠道为网站","negative":false},"action":{"type":"S","expr":"S","branches":[{"type":"A","expr":"r10127"},{"type":"A","expr":"r10128"}]}}],"action":{"type":"A","expr":"r10134"}}}',
     1, 0)
ON CONFLICT(id) DO UPDATE SET
    name=excluded.name, description=excluded.description, rule_tree=excluded.rule_tree,
    status=excluded.status, version=rule_flow.version + 1, updated_at=datetime('now','localtime')
